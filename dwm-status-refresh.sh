...
# This function should be clled each second.
...
xsetroot -name " 💿 $(print_mem)G ⏬ $vel_recv ⏫ $vel_trans $(dwm_alsa) [ $(print_bat) ]$(show_record) $(print_date) "
